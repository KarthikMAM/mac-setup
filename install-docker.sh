...
curl -L https://raw.githubusercontent.com/docker/machine/v0.14.0/contrib/completion/bash/docker-machine.bash > $(brew --prefix)/etc/bash_completion.d/docker-machine
